...
// LazyLoad ensures the page ONLY loads when the route is clicked
function lazyLoad(view){
    //return() => import(`@/views/${view}.vue`)
    return() => import(`@/_PAGES/${view}`)
}
...
const routes = [
    {
        ...
        name: 'Home',
        exact: true,
        component: lazyLoad ('MAXMET_Report_TABLE/MAXMET_Report_TABLE.vue'),
        meta: {
            breadcrumb: [{ parent: '-', label: 'Metric Report' }],
        },
        alias: [
            '/report'
        ],             
...

    {
        path: '/kpi',
        name: 'kpi',
        component: lazyLoad ('MAXMET_KPI/MAXMET_KPI.vue'),
        meta: {
            breadcrumb: [{ parent: '-', label: 'KPIs Summary' }],
        },
    },    
